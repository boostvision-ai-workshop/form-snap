...
export function SocialButtons({ onGoogleClick, onGitHubClick, loading }: SocialButtonsProps) {
  ...
  // If neither provider is enabled, render nothing
  ...
  return (
    <div className="space-y-3">
      <div className="grid gap-2">
        ...
        {githubEnabled && (
          <Button
            ...
            className="w-full h-10 border-border text-foreground hover:bg-muted"
          >
            <svg className="mr-2 size-4 shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path
                fillRule="evenodd"
      ...
      {/* "or" divider — only shown when at least one OAuth button is rendered */}
