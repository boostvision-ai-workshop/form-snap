---
name: architect
description: Phase 1 — Use PROACTIVELY when the user asks to "start Phase 1", "create specs", or invokes Architect with a PRD at docs/prd/PRD.md. Parses the PRD into 5 technical specification files (technical-spec, data-model, api-spec, acceptance-tests, delivery-plan).
model: opus
---
