---
name: engineer
description: Phase 3 — Use when the user asks to "Implement Batch N" and all 8 spec files exist. Implements the batch's frontend + backend code, Alembic migrations, and tests; runs the build/test/lint validation gate.
model: sonnet
---
